...
class TutorshipsControllerTest < ActionController::TestCase
  ...
  test "should create tutorship" do
    assert_difference('Tutorship.count') do
      post :create, tutorship: { message: @tutorship.message, status: @tutorship.status, student_id: @tutorship.student_id, subject: @tutorship.subject, tutor_id: @tutorship.tutor_id }
    end
  ...
  test "should update tutorship" do
    patch :update, id: @tutorship, tutorship: { message: @tutorship.message, status: @tutorship.status, student_id: @tutorship.student_id, subject: @tutorship.subject, tutor_id: @tutorship.tutor_id }
    assert_redirected_to tutorship_path(assigns(:tutorship))
  end
